  ...
  return(
    <main className="min-h-screen p-6 bg-zinc-950">
      ...
      <div className="space-y-4">
        <div className="p-4 text-white rounded-2xl bg-zinc-900"> Calories: {Math.round(calories)} </div>
        <div className="p-4 text-white rounded-2xl bg-zinc-900"> Protein: {meal.protein}g </div>
        <div className="p-4 text-white rounded-2xl bg-zinc-900"> Carbs: {meal.carbs}g </div>
        <div className="p-4 text-white rounded-2xl bg-zinc-900"> Fat: {meal.fat}g </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="mt-2 ml-2 text-sm text-zinc-400"> Quantity (g) </p>
      </div>
